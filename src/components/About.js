    ...
    return (
        <div id="about" className="about-section">
          <div className="text-box">
            ...
            <p>Hello! I am a recent Computer Science graduate from UMass Amherst with a particular focus in data science. I am based in the Boston area but am willing to relocate for the right position. I excel at data analytics, building web applications, and especially enjoy designing user interfaces. Additionally, my academic and professional journey has given me extensive exposure to database management and cloud technologies, particularly AWS. Outside of tech, I love to watch movies, ski, golf, and play basketball. </p>
