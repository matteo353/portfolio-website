    ...
    return (
        <div id="about" className="about-section">
          <div className="text-box">
            ...
            <p>I am a recent computer science graduate from UMass Amherst with a particular focus in data science. I excel at data analytics, software development and I especially enjoy working in team environments. Additionally, my academic and professional background have exposed me to databases and cloud technologies, particularly SQL databases and AWS. Outside of technology, I love to watch movies, ski, golf, and play basketball. </p>
